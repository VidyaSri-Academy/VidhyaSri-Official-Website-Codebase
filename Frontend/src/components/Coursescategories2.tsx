...
export default function IntegratedProgramCards2() {
  return (
    <>
      ...
      <div
        className="group animated-gradient-bg rounded-xl shadow-md hover:shadow-2xl hover:scale-[1.03] transition-all duration-300 ease-in-out flex flex-col"
        style={{
          backgroundImage:
            "repeating-linear-gradient(135deg, #e0e7ff 0px, #e0e7ff 2px, transparent 2px, transparent 24px)",
        }}
      >
        <div className="mt-6 md:mt-10 mx-auto lg:max-w-6xl xl:px-0 px-4 w-full flex flex-col items-center justify-center">
          ...
          <p className="md:text-lg text-base text-slate-600 md:leading-relaxed text-center leading-relaxed max-w-2xl">
            Vidhyasri offers a range of courses for students. Explore our
            programs Graduate and Post Graduate to find the perfect one for you.
          </p>
